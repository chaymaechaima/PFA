...
const Costume1 = () => {
    ...
    const [mainProductImage, setMainProductImage] = useState(require('../pics/categories/case1/case29.webp'));
    ...
    let img = 'case29.webp'
    let img1 = require('../pics/categories/case1/case29.webp')
    let img2 = require('../pics/categories/case1/case30.webp')
    let img3 = require('../pics/categories/case1/case31.webp')
    let img4 = require('../pics/categories/case1/case32.webp')
                        ...
                        <div class="col-md-6">
                            <div class="p-3 right-side">
                                <div class="d-flex justify-content-between align-items-center">
                                    <h3>Seahorse SE85 Slim Hard Protective Case</h3>
                                </div>
                                ...
                                <div class="buttons d-flex flex-row mt-5 gap-3">
                                    <button class="btn btn-outline-dark" onClick={() => handleAddToCart(img, "Seahorse SE85 Slim Hard Protective Case", 4962)}>Acheter</button>
                                </div>
