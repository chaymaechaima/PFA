...
const Costume = () => {
    ...
    const [mainProductImage, setMainProductImage] = useState(require('../pics/categories/case1/case1.jpg'));
    ...
    let img = 'case1.jpg'
    let img1 = require('../pics/categories/case1/case1.jpg')
    let img2 = require('../pics/categories/case1/case2.webp')
    let img3 = require('../pics/categories/case1/case3.webp')
    let img4 = require('../pics/categories/case1/case4.webp')
                        ...
                        <div class="col-md-6">
                            <div class="p-3 right-side">
                                ...
                                <div class="buttons d-flex flex-row mt-5 gap-3">
                                    <button class="btn btn-outline-dark" onClick={() => handleAddToCart(img, "PRO-gide SE1233 Hard Protective Crate", 4962)}>Acheter</button>
                                </div>
