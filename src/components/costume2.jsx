...
const Costume1 = () => {
    ...
    const [mainProductImage, setMainProductImage] = useState(require('../pics/categories/case1/case5.webp'));
    ...
    let img = 'case5.webp'
    let img1 = require('../pics/categories/case1/case5.webp')
    let img2 = require('../pics/categories/case1/case6.webp')
    let img3 = require('../pics/categories/case1/case7.webp')
    let img4 = require('../pics/categories/case1/case8.webp')
                        ...
                        <div class="col-md-6">
                            <div class="p-3 right-side">
                                <div class="d-flex justify-content-between align-items-center">
                                    <h3>PRO-gide SE1233 Hard Protective Crate</h3>
                                </div>
                                ...
                                <div class="buttons d-flex flex-row mt-5 gap-3">
                                    <button class="btn btn-outline-dark" onClick={() => handleAddToCart(img, "PRO-gide SE1231 Hard Protective Case", 4962)}>Acheter</button>
                                </div>
