        ...
        <main class="flex-shrink-0">
            ...
            <header id="header-a" class="bg-white py-5">
                <div class="container px-5">
                    <div class="row gx-5 align-items-center justify-content-center">
                        ...
                        <div class="col-xl-5 col-xxl-6  d-xl-block text-center"><img class="img-fluid rounded-3 my-5" src={img} alt="..." /></div>
                    </div>
                </div>
            </header>
            ...
            <section class="py-5" id="features">
                ...
                {windowWidth > 767 ? (
                    ...
                    {windowWidth < 767 ? (
                    <div class="row gx-5">
                        <div class="col-lg-4 mb-5 mb-lg-0"><h2 class="display-5 fw-bolder text-black mb-2">Nos valeurs</h2></div>   
                        <div class="col-lg-8">
                            <div class="row gx-5 row-cols-1 row-cols-md-2">
                                <div class="col mb-5 h-100">
                                    <div class="feature bg-primary bg-gradient text-white rounded-3 mb-3"><i class="bi bi-person-badge"></i></div>
                        ...
                        <div class="col-lg-4 mb-5 mb-lg-0"><h2 class="display-5 fw-bolder text-black mb-2"></h2><img id="case-img2" className="img-fluid" src={img2}></img> </div>
                    </div>):null}
