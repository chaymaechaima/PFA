...
const Costume1 = () => {
    ...
    const [mainProductImage, setMainProductImage] = useState(require('../pics/categories/case6.jpg'));
    ...
    let img = 'case21.webp'
    let img1 = require('../pics/categories/case1/case21.webp')
    let img2 = require('../pics/categories/case1/case22.webp')
    let img3 = require('../pics/categories/case1/case23.webp')
    let img4 = require('../pics/categories/case1/case24.webp')
                        ...
                        <div class="col-md-6">
                            <div class="p-3 right-side">
                                <div class="d-flex justify-content-between align-items-center">
                                    <h3>Seahorse SE1530 Hard Shell Protective Rifle Case</h3>
                                </div>
                                ...
                                <div class="buttons d-flex flex-row mt-5 gap-3">
                                    <button class="btn btn-outline-dark" onClick={() => handleAddToCart(img, "Seahorse SE1530 Hard Shell Protective Rifle Case", 4962)}>Acheter</button>
                                </div>
