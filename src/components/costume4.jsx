...
const Costume1 = () => {
    ...
    const [mainProductImage, setMainProductImage] = useState(require('../pics/categories/case1/case13.webp'));
    ...
    let img = 'case13.webp'
    let img1 = require('../pics/categories/case1/case13.webp')
    let img2 = require('../pics/categories/case1/case14.webp')
    let img3 = require('../pics/categories/case1/case15.webp')
    let img4 = require('../pics/categories/case1/case16.webp')
                        ...
                        <div class="col-md-6">
                            <div class="p-3 right-side">
                                <div class="d-flex justify-content-between align-items-center">
                                    <h3>PRO-gide SE57 Micro Hard Protective Case</h3>
                                </div>
                                ...
                                <div class="buttons d-flex flex-row mt-5 gap-3">
                                    <button class="btn btn-outline-dark" onClick={() => handleAddToCart(img, "PRO-gide SE57 Micro Hard Protective Case", 4962)}>Acheter</button>
                                </div>
